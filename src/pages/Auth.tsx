...
import RegisterForm from "@/pages/auth/RegisterFrom.tsx";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <main className="w-full max-w-md animate-fade-in">
        ...
        {/*Card Auth*/}
        <Card className="flex flex-col items-center mt-10 p-8 bg-gradient-card shadow-xl">
          <Tabs
            aria-label="auth-tab"
